...
func NewHaberdasherProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) Haberdasher {
	...
	serviceURL += baseServicePath(pathPrefix, "gen.haberdasher", "Haberdasher")
	urls := [1]string{
		serviceURL + "MakeHat",
	}
...
func (c *haberdasherProtobufClient) MakeHat(ctx context.Context, in *Size) (*Hat, error) {
	ctx = ctxsetters.WithPackageName(ctx, "gen.haberdasher")
...
const HaberdasherPathPrefix = "/twirp/gen.haberdasher.Haberdasher/"
...
func (s *haberdasherServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	if pkgService != "gen.haberdasher.Haberdasher" {
...
func (s *haberdasherServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "gen.haberdasher", "Haberdasher")
}
...
var twirpFileDescriptor0 = []byte{
	...
	0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0xe2, 0x4f, 0x4f, 0xcd, 0xd3, 0xcb, 0x48, 0x4c, 0x4a, 0x2d,
	0x4a, 0x49, 0x2c, 0xce, 0x48, 0x2d, 0x52, 0x72, 0xe6, 0x62, 0xf6, 0x48, 0x2c, 0x11, 0x12, 0xe2,
	...
	0x72, 0xe5, 0xe2, 0xf6, 0x40, 0xd8, 0x29, 0x64, 0xc6, 0xc5, 0xee, 0x9b, 0x98, 0x9d, 0x0a, 0xb2,
	0x57, 0x54, 0x0f, 0xcd, 0x41, 0x7a, 0x20, 0x83, 0xa4, 0x44, 0x30, 0x84, 0x3d, 0x12, 0x4b, 0x9c,
	0xd8, 0xa2, 0x58, 0xf4, 0xd3, 0x53, 0xf3, 0x92, 0xd8, 0xc0, 0x7e, 0x31, 0x06, 0x04, 0x00, 0x00,
	0xff, 0xff, 0x65, 0x7b, 0x81, 0xf7, 0xd8, 0x00, 0x00, 0x00,
}
